...
const ManageProducts = () => {
  ...
  // here preload -> will consist of all the products which are there in database
  const preload = () => {
  ...
  const deleteThisProduct = (productId) => {
    // deleteProduct -> will fire request to bakend for deleting this particular product
